  ...
  return (
    <Link
      ...
      className={clsx(
        ...
        variant === 'normal' &&
          'bg-honey-950/5 text-honey-950 hover:bg-honey-950/10 dark:bg-white/5 dark:text-white dark:inset-ring-1 dark:inset-ring-white/5 dark:hover:bg-white/10',
        variant === 'overlay' &&
          'bg-honey-950/15 text-white hover:bg-honey-950/20 dark:bg-honey-950/20 dark:hover:bg-honey-950/25',
        className,
      )}
    >
      ...
      <span
        className={clsx(
          ...
          variant === 'normal' && 'bg-honey-950/20 dark:bg-white/10',
      ...
      <span
        className={clsx(
          ...
          variant === 'normal' && 'text-honey-950 dark:text-white',
        )}
      >
