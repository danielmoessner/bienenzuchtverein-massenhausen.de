...
export function TestimonialTwoColumnWithLargePhoto({
  ...
  return (
    <section className={clsx('py-16', className)} {...props}>
      <Container>
        <figure className="grid grid-cols-1 gap-x-2 rounded-xl bg-honey-950/2.5 p-2 lg:grid-cols-2 dark:bg-white/5">
          <div className="flex flex-col items-start justify-between gap-10 p-6 text-honey-950 sm:p-10 dark:text-white">
            ...
            <figcaption className="text-sm/7">
              ...
              <p className="text-honey-700 dark:text-honey-400">{byline}</p>
            </figcaption>
          </div>
