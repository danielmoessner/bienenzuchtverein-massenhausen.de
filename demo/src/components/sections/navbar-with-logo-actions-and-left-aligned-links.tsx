...
export function NavbarLink({
  ...
  return (
    <Link
      href={href}
      className={clsx(
        'group inline-flex items-center justify-between gap-2 text-3xl/10 font-medium text-honey-950 lg:text-sm/7 dark:text-white',
        className,
      )}
      {...props}
    >
...
export function NavbarWithLogoActionsAndLeftAlignedLinks({
  ...
  return (
    <header className={clsx('sticky top-0 z-10 bg-honey-100 dark:bg-honey-950', className)} {...props}>
      ...
      <nav>
        <div className="mx-auto flex h-(--scroll-padding-top) max-w-7xl items-center gap-4 px-6 lg:px-10">
          ...
          <div className="flex flex-1 items-center justify-end gap-4">
            ...
            <button
              ...
              className="inline-flex rounded-full p-1.5 text-honey-950 hover:bg-honey-950/10 lg:hidden dark:text-white dark:hover:bg-white/10"
            >
        ...
        <ElDialog className="lg:hidden">
          <dialog id="mobile-menu" className="backdrop:bg-transparent">
            <ElDialogPanel className="fixed inset-0 bg-honey-100 px-6 py-6 lg:px-10 dark:bg-honey-950">
              <div className="flex justify-end">
                <button
                  command="close"
                  commandfor="mobile-menu"
                  aria-label="Toggle menu"
                  className="inline-flex rounded-full p-1.5 text-honey-950 hover:bg-honey-950/10 dark:text-white dark:hover:bg-white/10"
                >
                  <svg
