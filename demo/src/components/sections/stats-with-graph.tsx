...
export function Stat({
  ...
  return (
    <div className={clsx('border-l border-honey-950/20 pl-6 dark:border-white/20', className)} {...props}>
    ...
    <Section {...props}>
      ...
      <div className="pointer-events-none relative h-48 sm:h-64 lg:h-36">
        <div className="absolute bottom-0 left-1/2 w-[150vw] max-w-[calc(var(--container-7xl)-(--spacing(10)*2))] -translate-x-1/2">
          <svg
            className="h-100 w-full fill-honey-950/2.5 stroke-honey-950/40 dark:fill-white/2.5 dark:stroke-white/40"
