...
export function FeatureThreeColumnWithDemos({
  ...
  return (
    <div className={clsx('rounded-lg bg-honey-950/2.5 p-2 dark:bg-white/5', className)} {...props}>
      ...
      <div className="p-6 sm:p-10 lg:p-6">
        <h3 className="text-base/8 font-medium text-honey-950 dark:text-white">{headline}</h3>
        <div className="mt-2 flex flex-col gap-4 text-sm/7 text-honey-700 dark:text-honey-400">{subheadline}</div>
      </div>
    </div>
  )
}
