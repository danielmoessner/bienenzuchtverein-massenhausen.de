  ...
  return (
    <div
      className={clsx(
        ...
        variant === 'normal' && 'bg-white text-honey-600 inset-ring-black/10 dark:text-white',
    ...
    >
      ...
      <button
        ...
        commandfor="snippet"
        type="button"
        className="group relative flex size-9 items-center justify-center rounded-full after:absolute after:-inset-1 hover:bg-honey-950/10 dark:hover:bg-white/10 after:pointer-fine:hidden"
      >
